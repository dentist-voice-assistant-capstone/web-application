...
exports.verificationContent = (id) => {
  return `<div> <h3>Click the button below to activate your email address </h3>
  <a href='http://${process.env.FRONTEND_IP}:${process.env.FRONTEND_PORT}/register/verification/${id}'>
